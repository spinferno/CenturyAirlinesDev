...
namespace CenturyAirlines.Controllers
{
    public class CitiesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "CityID,CityName,CityCode")] Cities cities)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "CityID,CityName,CityCode")] Cities cities)
        {
            if (ModelState.IsValid)
            {
